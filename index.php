	...
	<form method="get" action="index.php">
	 		...
	 		<fieldset> 
	 			...
	 			<legend>faire le plein</legend> <!-- oui -->
		 			...
		 			<input type="radio" id="oui-q1" name="q1" required value="oui"/>
		 			<label for="non-q1">non</label>
		 			<input type="radio" id="non-q1" name="q1" required value="non"/>
	 		...
	 		<fieldset> 
	 			...
	 			<legend>nettoyer la voiture</legend> <!-- non -->
		 			...
		 			<input type="radio" id="oui-q2" name="q2" required value="oui" />
		 			<label for="non-q2">non</label>
		 			<input type="radio" id="non-q2" name="q2" required value="non" />
	 		...
	 		<fieldset> 
	 			...
	 			<legend>conduire papy à l'église</legend> <!-- non -->
		 			...
		 			<input type="radio" id="oui-q3" name="q3" required value="oui" />
		 			<label for="non-q3">non</label>
		 			<input type="radio" id="non-q3" name="q3" required value="non" />
	 		...
	 		<fieldset> 
	 			...
	 			<legend>passer le contrôle technique</legend> <!-- oui -->
		 			...
		 			<input type="radio" id="oui-q4" name="q4" required value="oui" />
		 			<label for="non-q4">non</label>
		 			<input type="radio" id="non-q4" name="q4" required value="non" />
	 		...
	 		<fieldset> 
	 			...
	 			<legend>aller faire les courses</legend> <!-- oui -->
		 			...
		 			<input type="radio" id="oui-q5" name="q5" required value="oui" />
		 			<label for="non-q5">non</label>
		 			<input type="radio" id="non-q5" name="q5" required value="non" />
	 		...
	 		<fieldset> 
	 			...
	 			<legend>je ferai du repassage pendant 2 semaines</legend> <!-- oui -->
		 			...
		 			<input type="radio" id="oui-q6" name="q6" required value="oui" />
		 			<label for="non-q6">non</label>
		 			<input type="radio" id="non-q6" name="q6" required value="non" />
